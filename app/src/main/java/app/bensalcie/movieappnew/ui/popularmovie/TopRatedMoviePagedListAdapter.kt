package app.bensalcie.movieappnew.ui.popularmovie
...
import app.bensalcie.movieappnew.ui.single_movie_details.SingleMovie
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.activity_single_movie.*
import kotlinx.android.synthetic.main.movie_list_item.view.*
import kotlinx.android.synthetic.main.network_state_item.view.*

class TopRatedMoviePagedListAdapter(public val context: Context): PagedListAdapter<TopRatedResponse.Result, RecyclerView.ViewHolder>(MovieDiffCallBack()) {
    ...
    class MovieDiffCallBack:DiffUtil.ItemCallback<TopRatedResponse.Result>(){
        /**
         ...
         */
        override fun areItemsTheSame(oldItem: TopRatedResponse.Result, newItem: TopRatedResponse.Result): Boolean {
         ...
         */
        override fun areContentsTheSame(oldItem: TopRatedResponse.Result, newItem: TopRatedResponse.Result): Boolean {
    ...
    class MovieItemViewHolder (view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie:TopRatedResponse.Result?,context:Context){
